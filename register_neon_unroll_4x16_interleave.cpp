...
// 4×16 微内核: C:16  + 4个B向量 + 1个A广播 = 21 寄存器
...
void cache_block(int M, int N, int K,
...
int main(int argc, char *argv[]) {
    ...
    GemmTimer::bench("register_neon_interleave_4x16", M, N, K, 100, [&](){ cache_block(M, N, K, A, lda, B, ldb, C_opt, ldc); });
