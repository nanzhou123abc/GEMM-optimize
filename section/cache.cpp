...
void cache_kji(int M, int N, int K,
             int Mc, int Nc, int Kc, int Mr, int Nr,
               ...
               float * __restrict__ B, int ldb,
               float * __restrict__ C, int ldc){
    if (!is_supported_kernel(Mr, Nr)) {
        std::printf("错误: 当前 section 只支持 Mr=%d, Nr=%d\n", 4, 16);
        return;
    }
    cache_kji_impl<4, 16>(M, N, K, Mc, Nc, Kc, A, lda, B, ldb, C, ldc);
}
...
void cache_kij(int M, int N, int K,
    ...
    cache_kij_impl<4, 16>(M, N, K, Mc, Nc, Kc, A, lda, B, ldb, C, ldc);
}
...
void cache_ijk(int M, int N, int K,
    ...
    cache_ijk_impl<4, 16>(M, N, K, Mc, Nc, Kc, A, lda, B, ldb, C, ldc);
}
...
void cache_ikj(int M, int N, int K,
    ...
    cache_ikj_impl<4, 16>(M, N, K, Mc, Nc, Kc, A, lda, B, ldb, C, ldc);
}
...
void cache_jik(int M, int N, int K,
    ...
    cache_jik_impl<4, 16>(M, N, K, Mc, Nc, Kc, A, lda, B, ldb, C, ldc);
}
...
void cache_jki(int M, int N, int K,
    ...
    cache_jki_impl<4, 16>(M, N, K, Mc, Nc, Kc, A, lda, B, ldb, C, ldc);
}
