    ...
    float *C, int ldc)
{
    ...
    for (; kr + 3 < Kc; kr += 4) {
        ...
        // ---- k+1 ----
        bv0 = vld1q_f32(bp + 16 + 0);
        bv1 = vld1q_f32(bp + 16 + 4);
        bv2 = vld1q_f32(bp + 16 + 8);
        bv3 = vld1q_f32(bp + 16 + 12);
        a0 = vld1q_dup_f32(ap + 4 + 0);
        a1 = vld1q_dup_f32(ap + 4 + 1);
        a2 = vld1q_dup_f32(ap + 4 + 2);
        a3 = vld1q_dup_f32(ap + 4 + 3);
        ...
        // ---- k+2 ----
        bv0 = vld1q_f32(bp + 2*16 + 0);
        bv1 = vld1q_f32(bp + 2*16 + 4);
        bv2 = vld1q_f32(bp + 2*16 + 8);
        bv3 = vld1q_f32(bp + 2*16 + 12);
        a0 = vld1q_dup_f32(ap + 2*4 + 0);
        a1 = vld1q_dup_f32(ap + 2*4 + 1);
        a2 = vld1q_dup_f32(ap + 2*4 + 2);
        a3 = vld1q_dup_f32(ap + 2*4 + 3);
        ...
        // ---- k+3 ----
        bv0 = vld1q_f32(bp + 3*16 + 0);
        bv1 = vld1q_f32(bp + 3*16 + 4);
        bv2 = vld1q_f32(bp + 3*16 + 8);
        bv3 = vld1q_f32(bp + 3*16 + 12);
        a0 = vld1q_dup_f32(ap + 3*4 + 0);
        a1 = vld1q_dup_f32(ap + 3*4 + 1);
        a2 = vld1q_dup_f32(ap + 3*4 + 2);
        a3 = vld1q_dup_f32(ap + 3*4 + 3);
...
int main(int argc, char *argv[]) {
    ...
    GemmTimer::bench("register_neon_u16oll_4x16", M, N, K, 100, [&](){ register_neon_u16oll_gemm(M, N, K, A, lda, B, ldb, C_opt, ldc); });
