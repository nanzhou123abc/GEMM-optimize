    ...
    float *C, int ldc)
{
    ...
    for (; kr + 3 < Kc; kr += 4) {
        ...
        // ---- k+1 ----
        bv0 = vld1q_f32(bp + Nr + 0);
        bv1 = vld1q_f32(bp + Nr + 4);
        bv2 = vld1q_f32(bp + Nr + 8);
        bv3 = vld1q_f32(bp + Nr + 12);
        a0 = vld1q_dup_f32(ap + Mr + 0);
        a1 = vld1q_dup_f32(ap + Mr + 1);
        a2 = vld1q_dup_f32(ap + Mr + 2);
        a3 = vld1q_dup_f32(ap + Mr + 3);
        ...
        // ---- k+2 ----
        bv0 = vld1q_f32(bp + 2*Nr + 0);
        bv1 = vld1q_f32(bp + 2*Nr + 4);
        bv2 = vld1q_f32(bp + 2*Nr + 8);
        bv3 = vld1q_f32(bp + 2*Nr + 12);
        a0 = vld1q_dup_f32(ap + 2*Mr + 0);
        a1 = vld1q_dup_f32(ap + 2*Mr + 1);
        a2 = vld1q_dup_f32(ap + 2*Mr + 2);
        a3 = vld1q_dup_f32(ap + 2*Mr + 3);
        ...
        // ---- k+3 ----
        bv0 = vld1q_f32(bp + 3*Nr + 0);
        bv1 = vld1q_f32(bp + 3*Nr + 4);
        bv2 = vld1q_f32(bp + 3*Nr + 8);
        bv3 = vld1q_f32(bp + 3*Nr + 12);
        a0 = vld1q_dup_f32(ap + 3*Mr + 0);
        a1 = vld1q_dup_f32(ap + 3*Mr + 1);
        a2 = vld1q_dup_f32(ap + 3*Mr + 2);
        a3 = vld1q_dup_f32(ap + 3*Mr + 3);
...
int main(int argc, char *argv[]) {
    ...
    GemmTimer::bench("register_neon_unroll_4x16", M, N, K, 100, [&](){ register_neon_unroll_gemm(M, N, K, A, lda, B, ldb, C_opt, ldc); });
