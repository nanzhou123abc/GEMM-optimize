...
void register_block_vv_4x4(
    ...
    a_reg0 = vld1q_lane_f32(ap0++, a_reg0, 0);
    a_reg0 = vld1q_lane_f32(ap1++, a_reg0, 1);
    a_reg0 = vld1q_lane_f32(ap2++, a_reg0, 2);
    a_reg0 = vld1q_lane_f32(ap3++, a_reg0, 3);
    ...
    bv1 = vld1q_f32(bp + 4); 
    for (; kr + 1 < k_len; kr += 2) {
        // prefetch: A 4 行下一条 cache line(64B) + B_pack 下一段(256B)
        ...
        bv2 = vld1q_f32(bp + 8); 
        bv3 = vld1q_f32(bp + 12);
        a_reg1 = vld1q_lane_f32(ap0++, a_reg1, 0);
        a_reg1 = vld1q_lane_f32(ap1++, a_reg1, 1);
        a_reg1 = vld1q_lane_f32(ap2++, a_reg1, 2);
        a_reg1 = vld1q_lane_f32(ap3++, a_reg1, 3);
...
void register_block_vv_5x4(
    ...
    float32x4_t a_reg0, a_reg1;
    float32x4_t a_reg_tail0, a_reg_tail1;

    a_reg0 = vld1q_lane_f32(ap0++, a_reg0, 0);
    a_reg0 = vld1q_lane_f32(ap1++, a_reg0, 1);
    a_reg0 = vld1q_lane_f32(ap2++, a_reg0, 2);
    a_reg0 = vld1q_lane_f32(ap3++, a_reg0, 3);
    a_reg_tail0 = vld1q_dup_f32(ap4++);
    ...
    for (; kr + 1 < k_len; kr += 2) {
        ...
        a_reg1 = vld1q_lane_f32(ap2++, a_reg1, 2);
        a_reg1 = vld1q_lane_f32(ap3++, a_reg1, 3);
        a_reg_tail1 = vld1q_dup_f32(ap4++);

        cv00 = vfmaq_laneq_f32(cv00, bv0, a_reg0, 0);  cv10 = vfmaq_laneq_f32(cv10, bv0, a_reg0, 1);  cv20 = vfmaq_laneq_f32(cv20, bv0, a_reg0, 2);  cv30 = vfmaq_laneq_f32(cv30, bv0, a_reg0, 3);
        cv40 = vfmaq_f32(cv40, bv0, a_reg_tail0);
        cv01 = vfmaq_laneq_f32(cv01, bv1, a_reg0, 0);  cv11 = vfmaq_laneq_f32(cv11, bv1, a_reg0, 1);  cv21 = vfmaq_laneq_f32(cv21, bv1, a_reg0, 2);  cv31 = vfmaq_laneq_f32(cv31, bv1, a_reg0, 3);
        cv41 = vfmaq_f32(cv41, bv1, a_reg_tail0);
        bp += 16;
        bv0 = vld1q_f32(bp + 0);
        bv1 = vld1q_f32(bp + 4);
        cv02 = vfmaq_laneq_f32(cv02, bv2, a_reg0, 0);  cv12 = vfmaq_laneq_f32(cv12, bv2, a_reg0, 1);  cv22 = vfmaq_laneq_f32(cv22, bv2, a_reg0, 2);  cv32 = vfmaq_laneq_f32(cv32, bv2, a_reg0, 3);
        cv42 = vfmaq_f32(cv42, bv2, a_reg_tail0);
        cv03 = vfmaq_laneq_f32(cv03, bv3, a_reg0, 0);  cv13 = vfmaq_laneq_f32(cv13, bv3, a_reg0, 1);  cv23 = vfmaq_laneq_f32(cv23, bv3, a_reg0, 2);  cv33 = vfmaq_laneq_f32(cv33, bv3, a_reg0, 3);
        cv43 = vfmaq_f32(cv43, bv3, a_reg_tail0);
        ...
        a_reg_tail0 = vld1q_dup_f32(ap4++);
        cv00 = vfmaq_laneq_f32(cv00, bv0, a_reg1, 0);  cv10 = vfmaq_laneq_f32(cv10, bv0, a_reg1, 1);  cv20 = vfmaq_laneq_f32(cv20, bv0, a_reg1, 2);  cv30 = vfmaq_laneq_f32(cv30, bv0, a_reg1, 3);
        cv40 = vfmaq_f32(cv40, bv0, a_reg_tail1);
        cv01 = vfmaq_laneq_f32(cv01, bv1, a_reg1, 0);  cv11 = vfmaq_laneq_f32(cv11, bv1, a_reg1, 1);  cv21 = vfmaq_laneq_f32(cv21, bv1, a_reg1, 2);  cv31 = vfmaq_laneq_f32(cv31, bv1, a_reg1, 3);
        cv41 = vfmaq_f32(cv41, bv1, a_reg_tail1);
        bp += 16;
        bv0 = vld1q_f32(bp + 0);
        bv1 = vld1q_f32(bp + 4);

        cv02 = vfmaq_laneq_f32(cv02, bv2, a_reg1, 0);  cv12 = vfmaq_laneq_f32(cv12, bv2, a_reg1, 1);  cv22 = vfmaq_laneq_f32(cv22, bv2, a_reg1, 2);  cv32 = vfmaq_laneq_f32(cv32, bv2, a_reg1, 3);
        cv42 = vfmaq_f32(cv42, bv2, a_reg_tail1);
        cv03 = vfmaq_laneq_f32(cv03, bv3, a_reg1, 0);  cv13 = vfmaq_laneq_f32(cv13, bv3, a_reg1, 1);  cv23 = vfmaq_laneq_f32(cv23, bv3, a_reg1, 2);  cv33 = vfmaq_laneq_f32(cv33, bv3, a_reg1, 3);
        cv43 = vfmaq_f32(cv43, bv3, a_reg_tail1);
...
void register_block_vv_6x4(
    ...
    a_reg0 = vld1q_lane_f32(ap2++, a_reg0, 2);
    a_reg0 = vld1q_lane_f32(ap3++, a_reg0, 3);
    a_reg_tail0 = vld1q_lane_f32(ap4++, a_reg_tail0, 0);
    a_reg_tail0 = vld1q_lane_f32(ap5++, a_reg_tail0, 1);
    ...
    for (; kr + 1 < k_len; kr += 2) {   
        ...
        a_reg1 = vld1q_lane_f32(ap2++, a_reg1, 2);
        a_reg1 = vld1q_lane_f32(ap3++, a_reg1, 3);
        a_reg_tail1 = vld1q_lane_f32(ap4++, a_reg_tail1, 0);
        a_reg_tail1 = vld1q_lane_f32(ap5++, a_reg_tail1, 1);

        cv00 = vfmaq_laneq_f32(cv00, bv0, a_reg0, 0);  cv10 = vfmaq_laneq_f32(cv10, bv0, a_reg0, 1);  cv20 = vfmaq_laneq_f32(cv20, bv0, a_reg0, 2);  cv30 = vfmaq_laneq_f32(cv30, bv0, a_reg0, 3);
        cv40 = vfmaq_laneq_f32(cv40, bv0, a_reg_tail0, 0);  cv50 = vfmaq_laneq_f32(cv50, bv0, a_reg_tail0, 1);
        cv01 = vfmaq_laneq_f32(cv01, bv1, a_reg0, 0);  cv11 = vfmaq_laneq_f32(cv11, bv1, a_reg0, 1);  cv21 = vfmaq_laneq_f32(cv21, bv1, a_reg0, 2);  cv31 = vfmaq_laneq_f32(cv31, bv1, a_reg0, 3);
        cv41 = vfmaq_laneq_f32(cv41, bv1, a_reg_tail0, 0);  cv51 = vfmaq_laneq_f32(cv51, bv1, a_reg_tail0, 1);
        bp += 16;
        bv0 = vld1q_f32(bp + 0);
        bv1 = vld1q_f32(bp + 4);
        cv02 = vfmaq_laneq_f32(cv02, bv2, a_reg0, 0);  cv12 = vfmaq_laneq_f32(cv12, bv2, a_reg0, 1);  cv22 = vfmaq_laneq_f32(cv22, bv2, a_reg0, 2);  cv32 = vfmaq_laneq_f32(cv32, bv2, a_reg0, 3);
        cv42 = vfmaq_laneq_f32(cv42, bv2, a_reg_tail0, 0);  cv52 = vfmaq_laneq_f32(cv52, bv2, a_reg_tail0, 1);
        cv03 = vfmaq_laneq_f32(cv03, bv3, a_reg0, 0);  cv13 = vfmaq_laneq_f32(cv13, bv3, a_reg0, 1);  cv23 = vfmaq_laneq_f32(cv23, bv3, a_reg0, 2);  cv33 = vfmaq_laneq_f32(cv33, bv3, a_reg0, 3);
        cv43 = vfmaq_laneq_f32(cv43, bv3, a_reg_tail0, 0);  cv53 = vfmaq_laneq_f32(cv53, bv3, a_reg_tail0, 1);
        ...
        a_reg_tail0 = vld1q_lane_f32(ap5++, a_reg_tail0, 1);
        cv00 = vfmaq_laneq_f32(cv00, bv0, a_reg1, 0);  cv10 = vfmaq_laneq_f32(cv10, bv0, a_reg1, 1);  cv20 = vfmaq_laneq_f32(cv20, bv0, a_reg1, 2);  cv30 = vfmaq_laneq_f32(cv30, bv0, a_reg1, 3);
        cv40 = vfmaq_laneq_f32(cv40, bv0, a_reg_tail1, 0);  cv50 = vfmaq_laneq_f32(cv50, bv0, a_reg_tail1, 1);
        cv01 = vfmaq_laneq_f32(cv01, bv1, a_reg1, 0);  cv11 = vfmaq_laneq_f32(cv11, bv1, a_reg1, 1);  cv21 = vfmaq_laneq_f32(cv21, bv1, a_reg1, 2);  cv31 = vfmaq_laneq_f32(cv31, bv1, a_reg1, 3);
        cv41 = vfmaq_laneq_f32(cv41, bv1, a_reg_tail1, 0);  cv51 = vfmaq_laneq_f32(cv51, bv1, a_reg_tail1, 1);
        bp += 16;
        bv0 = vld1q_f32(bp + 0);
        bv1 = vld1q_f32(bp + 4);

        cv02 = vfmaq_laneq_f32(cv02, bv2, a_reg1, 0);  cv12 = vfmaq_laneq_f32(cv12, bv2, a_reg1, 1);  cv22 = vfmaq_laneq_f32(cv22, bv2, a_reg1, 2);  cv32 = vfmaq_laneq_f32(cv32, bv2, a_reg1, 3);
        cv42 = vfmaq_laneq_f32(cv42, bv2, a_reg_tail1, 0);  cv52 = vfmaq_laneq_f32(cv52, bv2, a_reg_tail1, 1);
        cv03 = vfmaq_laneq_f32(cv03, bv3, a_reg1, 0);  cv13 = vfmaq_laneq_f32(cv13, bv3, a_reg1, 1);  cv23 = vfmaq_laneq_f32(cv23, bv3, a_reg1, 2);  cv33 = vfmaq_laneq_f32(cv33, bv3, a_reg1, 3);
        cv43 = vfmaq_laneq_f32(cv43, bv3, a_reg_tail1, 0);  cv53 = vfmaq_laneq_f32(cv53, bv3, a_reg_tail1, 1);
